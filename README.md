...
idempotency, rate limiting, fan-out, distributed transactions, observability, security) → **Systems**
(design TinyURL, Twitter, WhatsApp, YouTube, Uber, Ticketmaster, a payment system, and more,
...
**Pick your goal.** Two paths, your choice: **Learn system design** (understand + design real systems
...
what E4/E5/E6+ answers look like).
...
The MCP endpoint is `https://mcp.rundrill.com/skills/system-design` — the skills-course host, passing
`subject: "system-design"`. The server routes on the `/skills` segment and ignores the course name;
